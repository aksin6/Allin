...
display_header() {
    ...
    echo "║                              \__/                              ║"
    echo "║                                                              ║"
    echo "║    🦅  PTERODACTYL PANEL - Powered by GUDEL PROTECT  🛡️      ║"
...
deploy_protection() {
    ...
    in_func == 1 && /^\s*{/ {
        ...
        print "            throw new DisplayException(\"Lu Siapa Mau Delete User Lain Tolol? Izin Dulu Sama Id 1 Kalo Mau Delete©Protect By gudel - Protect V" version "\");";
        print "        }";
        in_func = 0; next;
    }
    { print }
    ...
    in_func == 1 && /^\s*{/ {
        ...
        print "            throw new DisplayException(\"Lu Siapa Mau Delete Server Lain Tolol? Izin Dulu Sama Id 1 Kalo Mau Delete©Protect By gudel - Protect V" version "\");";
        print "        }";
        in_func = 0; next;
    }
    { print }
...
admin_protection_setup() {
    ...
    bash <(curl -s https://raw.githubusercontent.com/aksin6/Allin/main/protectadmin.sh)
